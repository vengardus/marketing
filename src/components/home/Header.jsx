    ...
    <div class="isolate bg-white">
      <main>
        <div class="relative px-6 lg:px-8">
          <div class="mx-auto max-w-3xl xl:pt-40 xl:pb-64 lg:pt-56 lg:pb-48 pt-24 pb-12 sm:pt-48 sm:pb-40">
            <div>
              {/**
               ...
               */}
              <div>
                <h1 class="text-4xl font-semibold tracking-tight pb-24 sm:text-center sm:text-7xl">
                  Agency for <spam> </spam>
                <Typewriter

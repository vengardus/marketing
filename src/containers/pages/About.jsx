...
function About() {
  ...
  return (
    <Layout>
      {/**
       * React Helmet is a component to dynamically manage the document's
       * head section. Some common use cases include setting the title, 
       * description , and meta tags for the document. When combined with
       * server-side rendering, it allows you to set meta tags that will 
       * be read by search engines and social media crawlers
       */}
      {/* <Helmet> */}
